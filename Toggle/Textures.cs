...
namespace Toggle
{
    static class Textures
    {
        ...
        public static string[] graphicNames = { "kitten", "zombie", "player", "greenblock", "badgreenblock", "itemblock", "baditemblock", "inventory2", "BigPicture", "player_right", "sprites",
                                               "moveableVineBlock","vineBlock","cursor", "animals","battery","goo","berry","berryRot", "start","exit","buttonUp","buttonDown","buttonHUp","buttonHDown",
                                               "gateOpen","gateClose","lampoff","lampon","titleScreen2"};
